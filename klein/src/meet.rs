...
use crate::detail::exterior_product::{ext00, extPB, ext02};

#[cfg(target_arch = "x86_64")]
use std::arch::x86_64::*;

use crate::{Plane,Line,IdealLine,Branch, Point};
...
impl BitXor<Line> for Plane {
    ...
    // __m128 tmp;
    	...
    	unsafe {out.p3_ = _mm_add_ps(tmp, out.p3_);}
		return out
	}
}
impl BitXor<Plane> for Line {
	type Output = Point;
	#[inline]
	fn bitxor(self, rhs: Plane) -> Self::Output { rhs.bitxor(self) }}
...
mod tests {
    ...
    use crate::{Plane,Line,Point,IdealLine};
