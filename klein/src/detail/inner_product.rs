...
pub fn dot03(a: __m128, b: __m128, p1Out: &mut __m128, p2Out: &mut __m128) {
    ...
    unsafe {
        ...
        *p2Out = _mm_shuffle_ps(um, um, 120 /* 1, 3, 2, 0 */);
    }
}
...
// Plane | Line
#[inline]
pub fn dotPL_noflip(a: __m128, b: __m128, c: __m128) -> __m128 {
...
#[inline]
pub fn dotPL_flip(a: __m128, b: __m128, c: __m128) -> __m128 {
    // (a1 c1 + a2 c2 + a3 c3) e0 +
    // (a1 b2 - a2 b1) e3
    // (a2 b3 - a3 b2) e1 +
    // (a3 b1 - a1 b3) e2 +
...
// Plane | Ideal Line
#[inline]
pub fn dotPIL_flip(a: __m128, c: __m128) -> __m128 {
    hi_dp(a, c)
}

#[inline]
pub fn dotPIL_noflip(a: __m128, c: __m128) -> __m128 {
    let p0 = hi_dp(a, c);
